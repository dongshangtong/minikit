...
/**
 以iPhone X为高度适配
 */
#define HEIGHTSCALE(aheight) [[UIScreen mainScreen] bounds].size.height / 812 * aheight
...
//屏幕头部高 （包含状态栏高 + 导航条高）
#define SCREEN_TOP_HEIGHT (SCREEN_STATUS + NAVGATTIONHEIHT)
