...
@implementation UIImage (MNExtension)
+ (instancetype)mn_resizedImageWithImageName:(NSString *)name {
    return [self mn_resizedImageWithImage:[UIImage imageNamed:name]];
}

+ (instancetype)mn_resizedImageWithImage:(UIImage *)image {
    return [image stretchableImageWithLeftCapWidth:image.size.width * 0.5 topCapHeight:image.size.height * 0.5];
}

+ (instancetype)mn_cutImage:(UIImage*)image andSize:(CGSize)newImageSize {
...
+ (instancetype)mn_captureCircleImage:(UIImage *)image {
...
+ (instancetype)mn_captureCircleImageWithURL:(NSString *)iconUrl andBorderWith:(CGFloat)border andBorderColor:(UIColor *)color {
    return [self mn_captureCircleImageWithImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:iconUrl]]] andBorderWith:border andBorderColor:color];
}

+ (instancetype)mn_captureCircleImageWithImage:(UIImage *)iconImage andBorderWith:(CGFloat)border andBorderColor:(UIColor *)color {
...
+ (instancetype)mn_blurredImageWithImage:(UIImage *)image andBlurAmount:(CGFloat)blurAmount {
    return [image mn_blurredImage:blurAmount];
}

+ (instancetype)mn_viewShotWithView:(UIView *)view {
...
+ (instancetype)mn_waterImageWithBgImageName:(NSString *)bgName andWaterImageName:(NSString *)waterImageName {
...
+ (instancetype)mn_reduceImage:(UIImage *)image percent:(CGFloat)percent {
...
+ (instancetype)mn_imageWithImageSimple:(UIImage*)image scaledToSize:(CGSize)newSize {
...
+ (instancetype)mn_imageWithDataSimple:(NSData *)imageData scaledToSize:(CGSize)newSize {
    return [self mn_imageWithImageSimple:[UIImage imageWithData:imageData] scaledToSize:newSize];
}

- (instancetype)mn_blurredImage:(CGFloat)blurAmount {
...
- (instancetype)mn_blearImageWithBlurLevel:(CGFloat)blurLevel {
...
+ (instancetype)mn_imageWithColor:(UIColor *)color {
