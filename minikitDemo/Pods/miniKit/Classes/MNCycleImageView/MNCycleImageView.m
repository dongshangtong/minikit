...
@interface MNCycleImageView ()<UICollectionViewDelegate,UICollectionViewDataSource>
{
    NSInteger _index;
    BOOL _isScrol;
...
@property(nonatomic,strong)MNCycleImageViewPageControl *pageControl;
@property(nonatomic,strong)NSTimer *timer;

@end


@implementation MNCycleImageView

- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        
        self.movementDirection = MMovementDirectionForHorizontally;
...
{
    MNCycleImageViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"MNCycleImageViewCell" forIndexPath:indexPath];
...
#pragma mark - setter
- (void)setMovementDirection:(MMovementDirectionType)movementDirection
{
...
#pragma mark - getter
- (MNCycleImageViewPageControl *)pageControl
{
    if (!_pageControl) {
        
        _pageControl = [[MNCycleImageViewPageControl alloc]initWithFrame:CGRectMake(0, self.bounds.size.height - kPageControl_H, self.bounds.size.width, kPageControl_H)];
...
//        [_collectionView registerNib:[UINib nibWithNibName:@"MNCycleImageViewCell" bundle:nil] forCellWithReuseIdentifier:@"MNCycleImageViewCell"];
        
          [_collectionView registerClass:[MNCycleImageViewCell class] forCellWithReuseIdentifier:@"MNCycleImageViewCell"];
