...
+ (instancetype)mn_labelWithFont:(UIFont *)font textColor:(UIColor *)textColor superView:(UIView *)superView constraint:(void(^)(MASConstraintMaker *))constraint {
    return [UILabel mn_labelWithText:nil font:font textColor:textColor backgroundColor:[UIColor clearColor] superView:superView constraint:constraint];
}

+ (instancetype)mn_labelWithText:(nullable NSString *)text fontSize:(float)fontSize textColorValue:(uint)textColorValue backgroundColorValue:(uint)backgroundColorValue superView:(UIView *)superView constraint:(void(^)(MASConstraintMaker *))constraint {
...
+ (instancetype)mn_labelWithText:(nullable NSString *)text font:(UIFont *)font textColor:(UIColor *)textColor backgroundColor:(UIColor *)backgroundColor superView:(UIView *)superView constraint:(void(^)(MASConstraintMaker *))constraint {
