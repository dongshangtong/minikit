...
/**
 ...
 @return label
 */
+ (instancetype)mn_labelWithText:(nullable NSString *)text fontSize:(float)fontSize textColorValue:(uint)textColorValue backgroundColorValue:(uint)backgroundColorValue superView:(UIView *)superView constraint:(void(^)(MASConstraintMaker *make))constraint;
...
/**
 ...
 @return label
 */
+ (instancetype)mn_labelWithText:(nullable NSString *)text font:(UIFont *)font textColor:(UIColor *)textColor backgroundColor:(UIColor *)backgroundColor superView:(UIView *)superView constraint:(void(^)(MASConstraintMaker *make))constraint;
